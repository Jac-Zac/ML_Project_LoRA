...
if __name__ == "__main__":
    ...
    print("\033[92mDora Model predictions modified\033[0m")
    ...
    #     #     [
    #     #         dora_model.module.l1.dora_module.in_proj,
    #     #         dora_model.module.l1.dora_module.out_proj,
    #     #         dora_model.module.l2.dora_module.in_proj,
    #     #         dora_model.module.l2.dora_module.in_proj,
    #     #     ],
    #     #     lr=lr,
    #     # )
